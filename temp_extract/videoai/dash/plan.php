    ...
    <div class="col-lg-5">
        <div class="p-1">
            ...
            <form class="plan">
                ...
                <div class="form-group">
                    <label for="interval">
                        <p data-localize="interval"></p>
                    </label>
                    <select class="form-control" name="interval" id="interval">
                        <option value="N" data-localize="minute_plan"></option>
                        <option value="H" data-localize="hour_plan"></option>
                        <option value="D" data-localize="day" selected></option>
                        <option value="W" data-localize="week"></option>
                        <option value="M" data-localize="month"></option>
                        <option value="Y" data-localize="year"></option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="interval_count">
                        <p data-localize="interval_count"></p>
                    </label>

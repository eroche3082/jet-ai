...
$adminTenant = (isset($_SESSION['tenant']) && $_SESSION['tenant'] == 'lsv_mastertenant') ? true : false;
$masterTenant = $_SESSION['tenant_admin'] ?? '';
$tenant = $_SESSION['agent']['tenant'] ?? '';
$gettenant = isset($_GET['tenant']) ? $_GET['tenant'] : '';
?>
<!DOCTYPE html>
<html lang="en">

    <head>
        <title>LiveSmart Video AI Dashboard</title>
        ...
        <meta name="description" content="LiveSmart AI Video is a standalone web application to combine the amazing capabilities of OpenAI ChatGPT with a video avatar by your choice. Talk to the avatar or interact with the integrated chat.">
        <meta name="keywords" content="Video AI Avatars, ChatGPT, OpenAI, Multi Language, Voice Recognition">
        ...
        <div id="wrapper">
            ...
            if ($isInclude) {
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <?php } ?>
                    <?php if ($adminTenant && $paymentData['license'] === 'Extended License') { ?>
                        <li class="nav-item">

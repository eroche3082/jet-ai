                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <div id="error" class="d-none alert alert-danger"></div><br/>
                                        </div>
                                        <form class="user" method="post">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="username" autocomplete="off" aria-describedby="emailHelp" placeholder="Username">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <a href="javascript:void(0);" id="regbutton" class="btn btn-primary btn-user btn-block">
                                                Register
                                            </a>
                                            <hr>
                                        </form>

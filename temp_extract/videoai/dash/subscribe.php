        ...
        ?>
            ...
            <div class="card mb-3 border-left-info shadow m-3">
                ...
                <div class="card-footer">
                    <input class="form-control mt-auto" type="radio" required data-item_name="<?php echo $r['plan_id']; ?>" data-price="<?php echo $r['price']; ?>" data-currency="<?php echo $r['currency']; ?>" value="<?php echo $r['plan_id']; ?>" name="plan" id="plan<?php echo $r['plan_id']; ?>" style="height: calc(1.5em + 2px) !important;">
                </div>
            </div>
...
<form action="pay.php" method="post" name="payment-form" id="payment-form">
            ...
            <div class="p-1">
                <div class="form-group">
                    <label for="payment_method">
                        <p data-localize="payment_method"></p>
                    </label>
    ...
    <button type="button" id="submitButton" class="btn btn-primary" data-localize="subscribe"></button>
</form>

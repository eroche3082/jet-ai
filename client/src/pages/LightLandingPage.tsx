        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <svg viewBox="0 0 24 24" fill="none" className="h-8 w-8 text-orange-500" stroke="currentColor" strokeWidth="2">
            ...
            <div className="hidden md:flex space-x-8 text-gray-700">
              ...
              <Link href="/destinations" className="font-medium hover:text-orange-500 transition-colors">Destinations</Link>
              ...
              <Link href="/chat" className="font-medium hover:text-orange-500 transition-colors">AI Assistant</Link>
            </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            ...
            <Link href="/destinations" className="flex items-center text-orange-500 font-medium mt-4 md:mt-0 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md group">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-orange-500 font-semibold">Beach, Culture, Nature</p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md group">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-orange-500 font-semibold">Historic, Romantic, City</p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md group">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-orange-500 font-semibold">Cultural, Historic, Temples</p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg text-center shadow-md hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center bg-orange-100 rounded-full text-orange-500">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            ...
            <Link href="/blog" className="flex items-center text-orange-500 font-medium mt-4 md:mt-0 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <Link href="/blog/1" className="text-orange-500 font-medium hover:underline">Read More</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <Link href="/blog/2" className="text-orange-500 font-medium hover:underline">Read More</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <Link href="/blog/3" className="text-orange-500 font-medium hover:underline">Read More</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-8">
